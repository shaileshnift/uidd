    ...
    if (request.fHelp || request.params.size() != 2 ||
        ...
        throw std::runtime_error(
            RPCHelpMan{"addnode",
                ...
                RPCResults{},
                RPCExamples{
                    HelpExampleCli("addnode", "\"192.168.0.6:7860\" \"onetry\"")
            + HelpExampleRpc("addnode", "\"192.168.0.6:7860\", \"onetry\"")
                },
            }.ToString());
...
static UniValue disconnectnode(const JSONRPCRequest& request)
{
            RPCHelpMan{"disconnectnode",
                ...
                RPCResults{},
                RPCExamples{
                    HelpExampleCli("disconnectnode", "\"192.168.0.6:7860\"")
            + HelpExampleCli("disconnectnode", "\"\" 1")
            + HelpExampleRpc("disconnectnode", "\"192.168.0.6:7860\"")
...
static UniValue getaddednodeinfo(const JSONRPCRequest& request)
{
            ...
            "       {\n"
            "         \"address\" : \"192.168.0.201:7860\",  (string) The uidd server IP and port we're connected to\n"
