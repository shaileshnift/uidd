...
{
    int64_t amount = 0;
    BOOST_CHECK(ParseFixedPoint("0", 6, &amount));
    BOOST_CHECK_EQUAL(amount, 0LL);
    BOOST_CHECK(ParseFixedPoint("1", 6, &amount));
    BOOST_CHECK_EQUAL(amount, 100000000LL);
    BOOST_CHECK(ParseFixedPoint("0.0", 6, &amount));
    BOOST_CHECK_EQUAL(amount, 0LL);
    BOOST_CHECK(ParseFixedPoint("-0.1", 6, &amount));
    BOOST_CHECK_EQUAL(amount, -10000000LL);
    BOOST_CHECK(ParseFixedPoint("1.1", 6, &amount));
    BOOST_CHECK_EQUAL(amount, 110000000LL);
    BOOST_CHECK(ParseFixedPoint("1.10000000000000000", 6, &amount));
    BOOST_CHECK_EQUAL(amount, 110000000LL);
    BOOST_CHECK(ParseFixedPoint("1.1e1", 6, &amount));
    BOOST_CHECK_EQUAL(amount, 1100000000LL);
    BOOST_CHECK(ParseFixedPoint("1.1e-1", 6, &amount));
    BOOST_CHECK_EQUAL(amount, 11000000LL);
    BOOST_CHECK(ParseFixedPoint("1000", 6, &amount));
    BOOST_CHECK_EQUAL(amount, 100000000000LL);
    BOOST_CHECK(ParseFixedPoint("-1000", 6, &amount));
    BOOST_CHECK_EQUAL(amount, -100000000000LL);
    BOOST_CHECK(ParseFixedPoint("0.00000001", 6, &amount));
    BOOST_CHECK_EQUAL(amount, 1LL);
    BOOST_CHECK(ParseFixedPoint("0.0000000100000000", 6, &amount));
    BOOST_CHECK_EQUAL(amount, 1LL);
    BOOST_CHECK(ParseFixedPoint("-0.00000001", 6, &amount));
    BOOST_CHECK_EQUAL(amount, -1LL);
    BOOST_CHECK(ParseFixedPoint("1000000000.00000001", 6, &amount));
    BOOST_CHECK_EQUAL(amount, 100000000000000001LL);
    BOOST_CHECK(ParseFixedPoint("9999999999.99999999", 6, &amount));
    BOOST_CHECK_EQUAL(amount, 999999999999999999LL);
    BOOST_CHECK(ParseFixedPoint("-9999999999.99999999", 6, &amount));
    BOOST_CHECK_EQUAL(amount, -999999999999999999LL);

    BOOST_CHECK(!ParseFixedPoint("", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("-", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("a-1000", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("-a1000", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("-1000a", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("-01000", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("00.1", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint(".1", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("--0.1", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("0.000000001", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("-0.000000001", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("0.00000001000000001", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("-10000000000.00000000", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("10000000000.00000000", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("-10000000000.00000001", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("10000000000.00000001", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("-10000000000.00000009", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("10000000000.00000009", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("-99999999999.99999999", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("99999909999.09999999", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("92233720368.54775807", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("92233720368.54775808", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("-92233720368.54775808", 6, &amount));
    BOOST_CHECK(!ParseFixedPoint("-92233720368.54775809", 6, &amount));
